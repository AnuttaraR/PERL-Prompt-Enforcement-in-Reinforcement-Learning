# -*- coding: utf-8 -*-
"""Testing Llama 2 7B 32k Model.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1cwV1uoH2o87GIJpihpT8yf8f7QUSBtCa
"""
...
llm = AutoModelForCausalLM.from_pretrained("TheBloke/Llama-2-7B-32K-Instruct-GGUF", model_file="llama-2-7b-32k-instruct.Q4_K_M.gguf", model_type="llama", gpu_layers=8)


# Install required libraries
!pip install sentence-transformers pinecone-client nltk rouge-score bert-score transformers huggingface_hub
...
# Load E5 Base model for embeddings
...
def main():
    ...
    output_file = "../../Downloads/evaluation_results_llama_2_7B.json"
